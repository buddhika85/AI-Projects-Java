...
/* cheat code for theta
        theta = new FuzzyVariable("theta", "degrees", -90.0, 90.0, 2);
...
/* cheat code for dtheta
		double maxLeft = -2750.0;
        double maxRight = 2750.0;
        dtheta = new FuzzyVariable("dtheta", "degrees/sec", maxLeft, maxRight, 2);
...
/* cheat code for rules
        ...
        double[][] forces =
        {
            // h.left  left       s.left     straight      s.right     right    h.right
            {-MAX,      -MAX,     -0.5*MAX,  -0.25*MAX,    0.0,        0.0,     0.05*MAX}, // fast left
            {-MAX,      -MAX,     -0.25*MAX, -0.125*MAX,   0.0,        0.5*MAX, MAX},   // slow left
            {-MAX,      -MAX,     -0.25*MAX, 0.0,          0.25*MAX,   MAX,     MAX},   // still
            {-MAX,      -0.5*MAX, 0.0,       0.125*MAX,    0.25*MAX,   MAX,     MAX},   // slow right
            {-0.05*MAX,  0.0,     0.0,       0.25*MAX,     0.5*MAX,    MAX,     MAX}    // fast right
        };
