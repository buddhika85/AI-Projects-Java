...
{
	/*
	 Problem = manager of the service center wants to determine the number of spares required 
	 to maintain the actual mean delay in customer service within an acceptable range.
		we have three inputs – 
			(mean delay) m , (Number of servers) S, (Repair utilization factor of the service center) p and 
		one output – 
			(number of spare parts) n	 
	 */
