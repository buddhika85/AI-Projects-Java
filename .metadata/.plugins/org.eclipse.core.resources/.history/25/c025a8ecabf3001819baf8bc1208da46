...
public class MortgageES
{
    ...
    private FuzzyVariable house;	// calculated from location and market value - rating 0 to 10
    private FuzzyVariable asset;
    private FuzzyVariable income;
    private FuzzyVariable applicant;	// calculated from asset and income - rating 0 to 10
